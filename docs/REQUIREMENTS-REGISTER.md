...
| 2026-08-11 | REQ-036 | 招募仅指论文研究项目；删除当前招募、暑期体验项目、寒假培训、项目发布群及其他非论文项目记录 | REQ-035 中将课程、培训和发布渠道纳入人员招募的错误范围 | `content.js`、`site.js`、`recruitment/`、首页、维护文档、项目 AGENTS | 记录类型与状态检查、旧记录 ID 扫描、首页无当前招募、招募页结构回读、Pages 回读 | `resolved` |
