...
| REQ-024 | 项目基础概念 | 项目 00—09 的教学材料在进入方法和实践前，先说明该方向的核心概念、常见数据与基本对象、主要应用、常见研究问题和结果边界。进阶材料也应能独立阅读，不能只用一句话承接体验版；空间细胞通讯等复合主题需分别解释组成概念后再说明二者关系。 | 体验教学 00—05、进阶教学 00—05、后续项目 06—09 本地教学原型 | `resolved` | 2026-08-08 用户要求与读者视角审查 |
