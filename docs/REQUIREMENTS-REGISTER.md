...
| REQ-021 | 体验项目 03—05 | 教学项目需足以支撑题目 Notebook；题目版只留适量关键任务，参考答案按相同任务顺序给出代码与真实结果。材料可同步 GitHub/Kaggle 云端归档，但 Week 2 导航保持锁定，直到用户明确开放。 | 体验教学、实践、参考答案、结果资产、Kaggle | `resolved` | 2026-08-08 用户要求与本次生成脚本 |
| REQ-022 | 进阶项目 00—05 | 进阶版与体验版采用同构的教学、实践、参考答案形式，知识更深入并增加方法比较、验证设计和报告；材料同步云端归档，Kaggle 保持私有，网站导航仍锁定。项目 00 需要进阶版。 | 进阶教学、Notebook、报告、GitHub、Kaggle | `resolved` | 2026-08-08 用户要求与 `content/advanced-manifest.md` |
...
| 项目 00 没有进阶版；所有进阶材料只留本地 | 项目 00—05 均有进阶版；材料可同步云端归档，但网站导航仍锁定 | 被 REQ-022 替代 |
