...
- 体验版只用于完成和理解实践内容，不设置提交报告、撰写报告或报告提交要求；“记录结果”“说明观察”属于页面内的学习动作，可以保留。进阶版的设计报告、方法选择和验证说明只写在进阶材料及体验项目的进阶关系说明中。所有“需要完成的实践任务”板块的简介统一保留 AI 使用提示：“合理利用AI工具理解问题，学习知识并尝试给出适当的解决方案”。
