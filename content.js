...
window.KYDW.recruitment = {
  ...
  records: [
    ...
    },
    {
      ...
      mode: "跨校线上协作",
      commitment: "按定向培养型或论文导向型项目安排",
      capacity: "报名 33 人，筛选录取 23 人，另有内部推荐成员",
      audience: "对人工智能与生物医学交叉研究感兴趣的本科生",
      requirements: ["定向培养型项目可面向零基础同学", "论文导向型项目需要编程和科研基础"],
      work: ["科研思维、人工智能基础、数据处理与实验设计训练", "参与空间组学、生理信号、脑影像和医学影像等研究任务"],
      outcomes: ["完成跨校科研学习与协作", "论文和作者安排依据实际贡献和项目进展确定"],
      apply: "本期项目已经结束。后续批次在人员招募合集发布。",
      source: "KYDW·多校联合科研项目（第2501期）总结报告",
      updates: [
