window.KYDW = {
  ...
  team: {
    ...
    news: [
      ...
      { date: "2026.5", html: "团队本科生 <strong>汤昊天（23级）</strong>、<strong>Hanyu Cui</strong>、<strong>吴熙东（22级）</strong>、<strong>Yue Xu</strong>、<strong>Zhuoyuan Li</strong> 与 Liping Xie 的论文 <em>A Diffusion-Enhanced Classification System for Physiological Signal-based Diagnosis</em> 发表于 <strong>中科院一区 TOP 学术期刊 <em>Expert Systems With Applications</em></strong>。" },
      { date: "2026.5", html: "团队本科生 <strong>Zhengyang Miao</strong>、<strong>吴熙东（22级）</strong> 与 Liping Xie 的论文 <em>MDF: A Model Dispatching Framework with Noise-Estimator-Centric Experts for Robust Biosignal Classification</em> 收录于国际声学、语音与信号处理会议 <strong><em>ICASSP 2026</em></strong>。" },
      ...
      { date: "2026.2", html: "团队本科生 <strong>吴熙东（22级）</strong>、<strong>Mingke Yan</strong>、<strong>汤昊天（23级）</strong>、<strong>Dongchen Wu</strong> 与 Liping Xie 的论文 <em>MSCGN: Multiscale complementary gating network for time series classification</em> 发表于 <strong><em>Biomedical Signal Processing and Control</em></strong>。" },
      { date: "2026.1", html: "团队本科生 <strong>汤昊天（23级）</strong>、<strong>Mingke Yan</strong>、<strong>吴熙东（22级）</strong>、<strong>Hongkai Lai</strong>、<strong>Yang Zhang</strong>、<strong>Hanyu Cui</strong> 与 Liping Xie 的论文 <em>Lightweight element-wise product enhanced neural network for efficient arrhythmia detection on embedded devices</em> 发表于 <strong><em>Computer Methods and Programs in Biomedicine</em></strong>。" },
      { date: "2025.9", html: "团队 PhD <strong>阙宁锋（东北大学生物医学工程21级本科）</strong> 的论文 <em>Adaptive spatial transcriptomics interpolation via cross-modal cross-slice modeling</em> 以 early accepted 形式收录于 <strong>CCF B 类国际医学影像会议 <em>International Conference on Medical Image Computing and Computer Assisted Intervention（MICCAI 2025）</em></strong>。" },
      { date: "2025.9", html: "团队本科生 <strong>吴熙东（22级）</strong>、<strong>Hao Chen</strong>、<strong>Zhuoyuan Li</strong>、<strong>Chao Li</strong> 的论文 <em>OG-SAM: Enhancing Multi-Organ Segmentation with Organogenesis-Based Adaptive Modeling</em> 收录于 <strong>CCF B 类国际医学影像会议 <em>MICCAI 2025</em></strong> 研讨会 <strong><em>CMMCA 2025</em></strong>，并作 <strong>Oral</strong> 报告。" },
      { date: "2025.9", html: "团队本科生 <strong>蒋政（23级）</strong>、<strong>刘雪鹏（23级）</strong>、<strong>朱品安（24级）</strong> 的论文 <em>HaDM-ST: Histology-Assisted Differential Modeling for Spatial Transcriptomics Generation</em> 收录于 <strong>CCF B 类国际医学影像会议 <em>MICCAI 2025</em></strong> 研讨会 <strong><em>CMMCA 2025</em></strong>。" },
      ...
      { date: "2025.4", html: "团队本科生 <strong>吴熙东（22级）</strong>、<strong>Mingke Yan</strong>、<strong>Renqiao Wang</strong> 与 Liping Xie 的论文 <em>Multiscale feature enhanced gating network for atrial fibrillation detection</em> 发表于 <strong><em>Computer Methods and Programs in Biomedicine</em></strong>。" }
    ],
    homeNewsLimit: 8,
    leaders: [
      ...
      { name: "汤昊天", role: "2023 级负责人", preview: "东北大学生物医学工程专业 2023 级，现任 KYDW 2023 级负责人。以第一作者发表 CMBBE、MICCAI2025-CMMCA 论文，论文 A Diffusion-Enhanced Classification System for Physiological Signal-based Diagnosis 发表于 Expert Systems With Applications。", paragraphs: [
        ...
        "他的论文 A Diffusion-Enhanced Classification System for Physiological Signal-based Diagnosis 发表于中科院一区 Top 学术期刊 Expert Systems With Applications。",
      ...
      { name: "吴锡东", role: "2022 级负责人", preview: "东北大学生物医学工程专业学生，现任 2022 级负责人。以第一作者发表 CMBBE、BSPC 等 3 篇期刊论文，另有 MICCAI CMMCA Oral，现为新加坡国立大学医学院 PhD。", paragraphs: [
        "吴锡东是东北大学生物医学工程专业学生，现任 KYDW 2022 级负责人。",
  ...
  resourceCollections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "KYDW科研入门培训", text: "老版本的 KYDW 科研入门项目目前已不适用；现培训从电脑操作、文献阅读和数据基础开始，逐步进入 Python、人工智能、深度学习和科研实践。", href: "programs/training.html", home: true },
  ...
  experience: {
    ...
    simulationNote: "本页下方的“实际参考输出”来自对应实践项目已经保存的真实运行结果。网页代码单元格只能阅读，不能填写；要得到自己的结果，请在 Kaggle 中打开公开 Notebook，点击“复制并编辑”保存到自己的账户后运行和修改。",
    practiceGuidance: "实践项目可以下载到自己的电脑上运行；如果还不熟悉代码，建议直接在 Kaggle 上打开对应项目，点击“复制并编辑”保存到自己的账户，再按单元格逐步运行、修改并观察结果。看不懂时，可以向 AI 询问当前单元格在做什么，再根据提示一步步尝试。逐步借助 AI 读懂并完成代码，已经是当前科研实践中的必备能力。需要对照时，可以打开实践项目参考答案核对。",
    practiceTaskGuides: {
      "project-01": [
      ...
      "project-02": [
        ...
        { task: "任务 5：测试评价与阈值比较", fill: "比较 0.3、0.5、0.7 等候选阈值，在验证集选择 Dice 最好的阈值，再在测试集评价。", basis: "阈值只能用验证集选择；测试集用于最后一次评价，不能反过来选择阈值。", check: "确认最佳阈值、测试 Dice、IoU 和预测图像来自实际运行，预测 mask 与真实 mask 的形状一致。" }
      ],
      "project-03": [
        { task: "任务 1：解释归一化范围", fill: "在“你的回答”单元格说明为什么把图像归一化到生成器输出层使用的范围。", basis: "结合原始像素范围、数据变换、生成器最后一层激活函数和判别器输入范围说明，不能只写结论。", check: "后续代码运行时，真实图像与生成图像的数值范围应一致，显示图像时再转换回可视化范围。" },
        { task: "任务 2：补全生成器", fill: "完成 Generator 的转置卷积模块和输出层，使潜变量变成固定尺寸的单通道胸片。", basis: "根据 LATENT、目标图像尺寸、通道数和最后一层激活函数确定每层输入输出。", check: "输入一批随机噪声，确认生成结果形状和真实胸片一致，数值范围符合归一化设定。" },
        { task: "任务 3：补全对抗训练步骤", fill: "完成判别器和生成器交替训练中的真实/生成样本损失、反向传播与参数更新。", basis: "按照先更新判别器、再更新生成器的顺序，区分真实标签、假标签和生成器要优化的目标。", check: "确认 d、g 损失都有记录，训练曲线可以绘制，固定噪声能够在每轮生成样本。" },
        { task: "任务 4：结果检查", fill: "根据固定噪声生成样本、训练曲线和样本间距离检查生成质量与多样性。", basis: "结合样本是否清晰、不同样本是否相似、损失变化和距离统计进行判断，不要只看单张图。", check: "确认结果文件能够保存，样本网格、训练曲线和多样性指标与实际运行对应。" }
      ],
      "project-04": [
      ...
      "project-06": [
        ...
        { task: "任务 5：结论", fill: "根据数值和空间图写出模型相对基线的具体结论。", basis: "同时引用误差、相关性和空间结构，不只写‘效果更好’。", check: "结论能够对应前面实际运行的结果。" }
      ]
    },
    goal: "通过一组完整而易上手的研究任务，接触更多专业方向，在实践中发现自己的兴趣偏好与能力优势。",
    paragraphs: [
      "本项目以体验科研为核心，把领域前沿研究拆成一组简单、易懂、可以上手的体验项目，让本科生看到一个研究任务如何从数据开始，经过处理和建模，形成结果与解释。",
      ...
      "项目内容面向受众较广泛，欢迎从不熟悉的知识点或概念入手，自行检索资料或文献，逐步补全自己的知识网络。"
    ],
    facts: [
    ...
    levels: [
      { title: "体验版", text: "先阅读基础教学项目，再在实践项目中完成指定内容，完成后使用实践项目参考答案核对代码和分析过程。体验版不要求提交报告。" },
      { title: "进阶版", text: "进阶版难度更大、知识更深。体验数个方向后，如果对某个方向感兴趣，可以通过微信或邮件联系负责人刘涵瑜，完成进阶项目并撰写报告，作为后续课题组能力考察依据。当前进阶项目尚未开放。" }
    ],
    structure: [
