...
const _kydwProjectResults = {
  ...
  "project-03": [
    ...
    { taskIndex: 3, stepIndex: 3, title: "输入与生成结果", image: "experience/assets/results/project-03/task2_input_generated_comparison.png", caption: "胸片、留出集重建与潜空间采样结果对比", text: "数据集：NORMAL 胸片 1341 张；训练/留出：1073 / 268\n模型：ResidualConvVAE；潜变量维度：64\n留出集重建 L1：0.0878；生成样本两两 L1：0.2334\n五项图像特征平均差：0.0114" },
