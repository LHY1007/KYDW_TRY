window.KYDW = {
  ...
  team: {
    ...
    news: [
      { date: "2026.8", html: "团队本科生 <strong>万和欣（24级）</strong>、<strong>刘奕萱（24级）</strong>、<strong>周煜楷（25级）</strong>、<strong>伍东辰（23级）</strong> 的论文 <em>TASP: Task-Agnostic Structural Pretraining for 2D Medical Image Segmentation</em> 发表于 <strong>CCF C 类会议 British Machine Vision Conference（BMVC 2026，英国机器视觉会议）</strong>。" },
