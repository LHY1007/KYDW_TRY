window.KYDW = {
  ...
  team: {
    ...
    news: [
      { date: "2026.8", html: "团队本科生 <strong>朱鸿杰（23级）</strong>、<strong>周华苑（24级）</strong> 的论文 <em>An AI-Assisted Clinical Decision Support System for Green Classification of Cystocele on Dynamic Transperineal Ultrasound</em> 发表于 <strong>Journal of Medical Systems（影响因子 8.8）</strong>。" },
      ...
      { date: "2026.8", html: "团队本科生 <strong>朱鸿杰（23级）</strong>、<strong>周华苑（24级）</strong> 的论文 <em>TriSCoV-Net: Cross-Scale Verified Virtual Immunomarker Proxy Generation from Diffusion Magnetic Resonance Imaging</em> 发表于 <strong>CCF B 类国际顶级医学影像会议 International Conference on Medical Image Computing and Computer Assisted Intervention（MICCAI 2026）</strong> 研讨会 <strong>CMMCA 2026 Oral 级（排名第 2）</strong>。" },
      ...
      { date: "2026.6", html: "团队本科生 <strong>苗正洋（23级）</strong>、<strong>万和欣（24级）</strong>、<strong>伍东辰（23级）</strong>、<strong>汤昊天（23级）</strong> 的论文 <em>Multi-Source Feature Fusion with Self-Supervised Contrastive Learning for AF Detection under Label Scarcity</em> 发表于 <strong>AI Engineering（影响因子暂未公布）</strong>。" },
      { date: "2026.5", html: "团队本科生 <strong>汤昊天（23级）</strong>、<strong>崔涵禹（23级）</strong>、<strong>吴熙东（22级）</strong> 的论文 <em>A Diffusion-Enhanced Classification System for Physiological Signal-based Diagnosis</em> 发表于 <strong>Expert Systems With Applications（影响因子 9.4）</strong>。" },
      ...
      { date: "2026.5", html: "团队本科生 <strong>孙宇嘉（24级）</strong> 的论文 <em>TASC-SwinMT: Task-Adaptive Synergistic Cross-Task Swin Multi-Task Framework for CT and MRI Image Interpolation and Segmentation</em> 发表于 <strong>TOMOGRAPHY（影响因子 2.5）</strong>。" },
      { date: "2026.4", html: "团队 MPhil <strong>唐浩（东北大学生物医学工程21级本科）</strong> 的论文 <em>Generalized Spherical Neural Operators: Green's Function Formulation</em> 发表于 <strong>CCF A 类国际顶级人工智能会议 International Conference on Learning Representations（ICLR 2026）</strong>。" },
      { date: "2026.2", html: "团队本科生 <strong>吴熙东（22级）</strong>、<strong>汤昊天（23级）</strong>、<strong>伍东辰（23级）</strong> 的论文 <em>MSCGN: Multiscale complementary gating network for time series classification</em> 发表于 <strong>Biomedical Signal Processing and Control（影响因子 5.7）</strong>。" },
      { date: "2026.1", html: "团队本科生 <strong>汤昊天（23级）</strong>、<strong>吴熙东（22级）</strong>、<strong>崔涵禹（23级）</strong> 的论文 <em>Lightweight element-wise product enhanced neural network for efficient arrhythmia detection on embedded devices</em> 发表于 <strong>Computer Methods and Programs in Biomedicine（影响因子 6.4）</strong>。" },
      { date: "2025.11", html: "团队本科生 <strong>孙宇嘉（24级）</strong> 获 <strong>第十七届全国大学生数学竞赛（非数学 A 类）一等奖</strong>。" },
      { date: "2025.9", html: "团队本科生 <strong>汤昊天（23级）</strong>、<strong>唐欣蕊（22级）</strong>、<strong>吴运嘉</strong>、<strong>苗正洋（23级）</strong> 的论文 <em>Hierarchical Brain Structure Modeling for Predicting Genotype of Glioma</em> 发表于 <strong>CCF B 类国际顶级医学影像会议 International Conference on Medical Image Computing and Computer Assisted Intervention（MICCAI 2025）</strong> 研讨会 <strong>CMMCA 2025</strong>。" },
      { date: "2025.9", html: "团队 PhD <strong>阙宁锋（东北大学生物医学工程21级本科）</strong> 的论文 <em>Adaptive spatial transcriptomics interpolation via cross-modal cross-slice modeling</em> 以 early accepted 形式发表于 <strong>CCF B 类国际顶级医学影像会议 International Conference on Medical Image Computing and Computer Assisted Intervention（MICCAI 2025）</strong>。" },
      { date: "2025.9", html: "团队本科生 <strong>吴熙东（22级）</strong> 的论文 <em>OG-SAM: Enhancing Multi-Organ Segmentation with Organogenesis-Based Adaptive Modeling</em> 发表于 <strong>CCF B 类国际顶级医学影像会议 International Conference on Medical Image Computing and Computer Assisted Intervention（MICCAI 2025）</strong> 研讨会 <strong>CMMCA 2025</strong>，并作 <strong>Oral</strong> 报告。" },
      ...
      { date: "2025.4", html: "团队本科生 <strong>吴熙东（22级）</strong> 的论文 <em>Multiscale feature enhanced gating network for atrial fibrillation detection</em> 发表于 <strong>Computer Methods and Programs in Biomedicine（影响因子 6.4）</strong>。" }
    ],
    leaders: [
